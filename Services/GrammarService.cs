...
namespace FerOmega.Services
{
    public class GrammarService : IGrammarService
    {
        ...
        {
            OperatorType.CloseCurlyBracket, OperatorType.CloseRoundBracket, OperatorType.CloseSquareBracket,
        };

        private readonly OperatorType[] openBrackets =
        {
            OperatorType.OpenCurlyBracket, OperatorType.OpenRoundBracket, OperatorType.OpenSquareBracket,
        };
        ...
        public Operator Get(OperatorType operatorType)
        {
            if (!Enum.IsDefined(typeof(OperatorType), operatorType))
            {
                throw new ArgumentOutOfRangeException(nameof(operatorType),
                                                      operatorType,
                                                      $"Enum {nameof(OperatorType)} is out of range");
            }
        ...
        {
            return Operators.Where(x => closeBrackets.Contains(x.OperatorType))
                            .SelectMany(x => x.Denotations)
                            .Contains(denotation);
        }
        ...
        {
            return Operators.Where(x => openBrackets.Contains(x.OperatorType))
                            .SelectMany(x => x.Denotations)
                            .Contains(denotation);
        }
        ...
        private void SetOperators()
        {
            ...
            priority = AddOperators(priority,
                                    new Operator(ArityType.Multiarity,
                                                 AssociativityType.Left,
