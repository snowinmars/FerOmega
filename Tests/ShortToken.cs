...
namespace FerOmega.Tests
{
    ...
    {
        [JsonConstructor]
        public ShortToken(OperatorType operatorType)
            : this(operatorType, null) { }

        public ShortToken(int value)
            : this(OperatorType.Literal, value.ToString()) { }
        ...
        private string ToPlainEquation(Operator @operator)
        {
            ...
            {
                return
                    $"{Children[0].ToPlainEquation(true)} {@operator.MainDenotation} {Children[1].ToPlainEquation(true)}";
            }
...
#region equals
        ...
        public bool Equals(ShortToken other)
        {
            ...
            var areEquals = OperatorType == other.OperatorType && Value == other.Value;
